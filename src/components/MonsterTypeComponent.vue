<template>
    ...
    <div class="atribute-filters atribute-container">
                        <div @click="openFilter" class="atribute-head"><span>Monster Type</span><img :src="store.state.monsterTypeOpen ? NavigateOpen : NavigateClosed" /></div>
                        <div v-if="store.state.monsterTypeOpen" class="atribute-items">
                            <button class="atribute-button" @click="AtributeArrayMethod" v-for="monster in store.state.monsters" >{{ monster }}</button>
                        </div>
                    </div>
